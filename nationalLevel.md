...
本比赛不仅包含计算机相关的赛道：软件应用与开发、物联网应用、大数据应用、人工智能应用等，还包括一些与计算机结合的艺术赛道：如数媒动漫与短片、微课与AI辅助教学、计算机音乐创作等。适合软件学院的同学们参加。
...
- Web应用安全赛道：涉及Web漏洞挖掘、代码审计、安全防护等
...
参赛队伍由3-6名在读学生组成，每所高校可报送多支队伍参赛，鼓励跨校队伍合作参赛。
